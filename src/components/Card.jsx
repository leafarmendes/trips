    ...
    <div className="card--container">
      ...
      <div className="card--info">
        <div className="card--location">
          <svg width="20" height="25" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <h4 className="card--city h4--normal">
            {props.item.city}
          </h4>
          <h4 className="card--google_maps h4--link">
            View on Google Maps
          </h4>
        </div>
        
        <h1 className="card--title h1--txt">
          {props.item.location}
        </h1>
        ...
        <p className="card--description p--txt">
